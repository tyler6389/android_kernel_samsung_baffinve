...
#if defined(CONFIG_LTE_MODEM_CMC221) || defined(CONFIG_MACH_M0_CTC) || defined(CONFIG_UMTS_MODEM_SS222)
...
#if defined(CONFIG_LTE_MODEM_CMC221) || defined(CONFIG_UMTS_MODEM_SS222)
	if (kpcs_mode == 1) {
		switch (prate) {
		case 8000:
			bclk = 256000;
