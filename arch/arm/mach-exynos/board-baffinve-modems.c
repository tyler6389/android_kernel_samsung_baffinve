 ...
 */
#ifdef CONFIG_SEC_MODEM_BAFFINVE
...
static struct modem_data umts_modem_data = {
	...
	.gpio_tp_indicate = GPIO_LTE_INDICATE,
...
#endif /*CONFIG_SEC_MODEM_BAFFINVE*/
