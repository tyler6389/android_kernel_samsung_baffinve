...
extern u16 mem_menu_sensitivity;
extern u16 mem_back_sensitivity;
#endif
...
#if defined(READ_MEM_SENSITIVITY)
		/* Copy data directly due to the timing issue */
		mem_menu_sensitivity = si->btn_rec_data[0]; /* Menu Key */
		mem_back_sensitivity = si->btn_rec_data[1]; /* Back Key */
#endif
...
#ifdef CONFIG_HAS_EARLYSUSPEND
	bd->es.level = EARLY_SUSPEND_LEVEL_STOP_DRAWING - 1;
